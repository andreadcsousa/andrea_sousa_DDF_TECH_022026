...
O dataset completo **Amazon Products 2023 (1.4M registros)** não é versionado neste repositório devido ao seu tamanho.
...
3. Em seguida execute:
   ...
   - `03_llm_feature_extraction.ipynb` (quando implementado)
